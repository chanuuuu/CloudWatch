...
%>
            ...
            <div id="row" >
                 <a href="welcome.jsp" class="btn btn-danger">GO BACK!</a>
                 
             
                  </br><h4><b><u>Total List of alarms on Virtual Machines:</u></b></h4>
                  <%
                  
                  Object[] alpha= AlarmThread.listAlarms();
                  if(alpha.length != 0)
                  {
                 ...
                 %>
                  ...
                  </br><h4><b><u>Total List of alarms ON Virtual Hosts:</u></b></h4>
                  
               
                  <%
                  
                  Object[] alpha1= HostAlarmThread.listAlarms();
                  if(alpha.length != 0)
                  {
            ...
            <div id="deleteonvm" class="delete" style="padding:20px 0px 0px 20px">
             <form class="form-horizontal" role="form" action="deletevmalarm.jsp">
            <label>Name the Virtual Machine Alarm to delete</label>
            <input type="text" class="form-control" name="vmalarmname"  style="width:200px" placeholder="Name of the Alarm">
			
            <button class="btn btn-primary" style="margin:20px 0px 0px 40px;">DELETE</button>
            </form>
            </div>
            
            
            <div id="deleteonvh" class="delete" style="padding:20px 0px 0px 20px">
            
             <form class="form-horizontal" role="form" action="deletevhalarm.jsp">
            <label>Name the Virtual Host Alarm to delete</label>
            <input type="text" class="form-control" name="vhalarmname" style="width:200px;" placeholder="Name of the Alarm">
