...
%>
 	<a href="welcome.jsp" class="btn btn-danger" style="margin:60px 0px 0px 620px;position:relative">GO BACK!</a>
            <div id="row1" >
                 
                 
                 <table>
                 <h3><u>Available Virtual Hosts</u></h3>
                 <%
                 
                 Object[] alpha= HostAlarmThread.listVms();
                 if(alpha.length != 0)
                 {
                 for(int i=0;i<alpha.length;i++)
                 {
              	   out.println( "<br>"+alpha[i].toString()+"<br>");
              	   
                 }
                 }
                 else
                 {
              	   out.println("No Hosts Available."+"\n");
                 }
            ...
            <div id="row2" >
                 ...
                 <table>
                 <h3><u>Available Virtual Machines</u></h3>
                 <%
                 
                 Object[] alpha1= AlarmThread.listVms();
                 if(alpha1.length != 0)
                 {
                 for(int i=0;i<alpha1.length;i++)
                 {
              	   out.println( "<br>"+alpha1[i].toString()+"<br>");
              	   
                 }
                 }
                 else
                 {
              	   out.println("No Virtual Machines Available."+"\n");
                 }
